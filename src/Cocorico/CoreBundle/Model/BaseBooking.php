...
//        self::STATUS_CANCELED_OFFERER,
    ...
    /**
     * @ORM\Column(name="accepted_booking_at", type="datetime", nullable=true)
     *
     * @var \DateTime
     */
     ...
     * PayPal paykey
     *
     * @ORM\Column(name="paykey", type="string", length=255, nullable=true)
     *
     * @var string
     */
    protected $paykey;
    ...
    /**
     * @ORM\Column(name="payout_booking_at", type="datetime", nullable=true)
     *
     * @var \DateTime
     */
    protected $payoutBookingAt;
     ...
     * @return \DateTime
     */
    public function getAcceptedBookingAt()
    {
        return $this->acceptedBookingAt;
    }

    /**
     * @param $acceptedBookingAt
     * @return $this
     */
    public function setAcceptedBookingAt($acceptedBookingAt)
    {
        $this->acceptedBookingAt = $acceptedBookingAt;
     ...
     * @return \DateTime
     */
    public function getPayoutBookingAt()
    {
        return $this->payoutBookingAt;
    }

    /**
     * @param \DateTime $payoutBookingAt
     *
     * @return $this
     */
    public function setPayoutBookingAt($payoutBookingAt)
    {
        $this->payoutBookingAt = $payoutBookingAt;
