...
//            echo $interval->invert . "<br>";
     ...
     * @return bool
     */
    public function isAcceptableStatus()
    {
    ...
    /**
     * @param bool $time_unit_is_day
     * @return array
     */
    public function getTimeRange($time_unit_is_day)
    {
        return $time_unit_is_day ? [] : [new TimeRange($this->getStartTime(), $this->getEndTime())];
    }
